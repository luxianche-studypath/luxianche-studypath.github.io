...
Inspired by the **Deravitive Product Rule**$\frac{\mathrm{d}y}{\mathrm{d}x}(vy)=y'v+yv'$
...
> 3. $$u_n \to 0$$
>
> 并且$$|L-s_n|<u_{n+1}$$并且$$|L-s_n|$$和$$u_{n+1}$$同号
...
>
> 1. |x-a|>R发散,|x-a|<R收敛,在a+R和a-R,可能收敛也可能发散
> 2. 级数对每个x收敛
> 3. 级数在x=a收敛,在其余的点发散
...
<img src="D:\图片\20140506113335-861180098.jpg" style="zoom:150%;" />
...
<img src="D:\图片\下载 (10).jpg" style="zoom:150%;" />
...
<img src="D:\图片\images.png" style="zoom:200%;" />
